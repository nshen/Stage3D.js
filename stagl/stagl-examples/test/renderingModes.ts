...
module test.renderingModes {
    ...
    var trianglesIB: stagl.IndexBuffer3D;

    //index buffers
    var linesIB: stagl.IndexBuffer3D;
    var pointsIB: stagl.IndexBuffer3D;
    var lineLoopIB: stagl.IndexBuffer3D;
    var lineStripIB: stagl.IndexBuffer3D;
    var triangleStripIB: stagl.IndexBuffer3D;
    var triangleFanIB: stagl.IndexBuffer3D;
    ...
    function onCreated(e: stagl.events.Event): void
    {
        ...
        *                             #2(0,-0.5)
        */
        var vertexBuffer: stagl.VertexBuffer3D = context3d.createVertexBuffer(5, 3);

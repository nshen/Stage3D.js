...
module GPUSprite
{
    export class GPUSpriteRenderLayer
    {
        ...
        private _parent:GPUSpriteRenderStage;
        private _children:GPUSprite[];
        ...
        public constructor(context3D:stageJS.Context3D , spriteSheet:GPUSpriteSheet)
        {
        ...
        public get parent() : GPUSpriteRenderStage
        {
            return this._parent;
        }

        public set parent(parentStage:GPUSpriteRenderStage)
        {
...
//            this._shaderProgram.upload( vertexShaderAssembler.agalcode, fragmentShaderAssembler.agalcode );
        ...
        private updateChildVertexData(sprite:GPUSprite) : void
        {
